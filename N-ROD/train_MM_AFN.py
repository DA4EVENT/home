...
hp_list = ["MM_AFN_Single_Modal", "Source_"+args.source, "Target_"+args.target, "LR" + str(args.lr),"BS"+str(args.batch_size), "AVG"+str(args.AvgChannels), args.modality]
    ...
    with tqdm(total=len(train_loader_source), desc="Train") as pb:
        for batch_num, (img_rgb, img_event, img_label_source) in enumerate(train_loader_source_rec_iter):
            ...
            with OptimizerManager(optims_list, batch_num, args.num_accumulation):
                ...
                del img_rgb, img_event, img_label_source, feat_rgb, features_source, feat_event, logits, emb
                ...
                if (args.weight_ent > 0.0) or (args.weight_afn > 0.0):
                    ...
                    # Backprop AFN e/o Entropy
                    loss = (args.weight_ent * loss_ent + loss_afn * args.weight_afn) * SCALE_Accumulation
                    loss.backward()
                    del img_rgb, img_event, features_target, feat_rgb, feat_event, logits, emb
