...
def add_base_args(parser: argparse.ArgumentParser):
    ...
    #Caltech - Cifar
    parser.add_argument('--dataset', default='', choices=['Cifar10', 'caltech101','ncaltech101'])
    ...
    parser.add_argument('--target_data_format', default='evrepr',
                        choices=['evrepr', 'rgb', 'event_bin', 'event_aedat', 'event_images',
                                 'rgb-evrepr', 'rgb-event_bin', 'rgb-event_aedat', 'event_npz', 'rgb-event_images'])
    ...
    parser.add_argument("--task", default="rgb-event-rr")
